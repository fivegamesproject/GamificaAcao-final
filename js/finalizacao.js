...
// Exemplo de como mostrar o modal após 3 segundos
...
function loop() {
	if (!isFireworksRunning) {
        return; // Para a execução se os fogos de artifício não devem estar rodando
    }
...
// Inicialize a animação como parada
isFireworksRunning = false;

// Modifique as funções startFireworks e stopFireworks
function startFireworks() {
